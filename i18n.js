...
translations: {
    en: {
        ...
        'achievements.3_day_streak': '3-day streak',
        'achievements.week_warrior': 'Week Warrior',
        'achievements.7_day_streak': '7-day streak',
        'achievements.fortnight_focus': 'Fortnight Focus',
        'achievements.14_day_streak': '14-day streak',
        'achievements.monthly_master': 'Monthly Master',
        'achievements.30_day_streak': '30-day streak',
        'achievements.quarter_champion': 'Quarter Champion',
        'achievements.90_day_streak': '90-day streak',
        'achievements.perfect_week': 'Perfect Week',
        'achievements.completed_7_days': 'Completed all 7 days this week',
        'achievements.consistent_week': 'Consistent Week',
        'achievements.completed_5_days': 'Completed 5+ days this week',
        'achievements.first_steps': 'First Steps',
        'achievements.dedicated': 'Dedicated',
        'achievements.century': 'Century',
        'achievements.year_round': 'Year-Round',

        // Crisis Support
        'crisis.title': 'Crisis Support',
        'crisis.message': 'We noticed you may be going through a difficult time. Remember, you are not alone and help is available.',
        'crisis.contact_therapist': 'Contact Your Therapist',
        'crisis.hotline_suicide': 'National Suicide Prevention Lifeline',
        'crisis.hotline_text': 'Crisis Text Line',
        'crisis.hotline_israel': 'ERAN - Emotional First Aid',
        'crisis.available_24_7': '24/7',
        'crisis.text_home': 'Text HOME to 741741',
        'crisis.phone_988': '988',
        'crisis.phone_eran': '1201',
        ...
        'reports.daily_checkin_title': 'Daily Check-in Reports (Last 7 Days)',
'reports.daily_checkin_desc': 'Generate a comprehensive report of your check-ins for the past 7 days.',
    ...
    he: {
        ...
        // Achievements
        'achievements.getting_started': 'מתחילים',
        'achievements.3_day_streak': 'רצף של 3 ימים',
        'achievements.week_warrior': 'לוחם השבוע',
        'achievements.7_day_streak': 'רצף של 7 ימים',
        'achievements.fortnight_focus': 'מיקוד דו-שבועי',
        'achievements.14_day_streak': 'רצף של 14 ימים',
        'achievements.monthly_master': 'אמן החודש',
        'achievements.30_day_streak': 'רצף של 30 ימים',
        'achievements.quarter_champion': 'אלוף הרבעון',
        'achievements.90_day_streak': 'רצף של 90 ימים',
        'achievements.perfect_week': 'שבוע מושלם',
        'achievements.completed_7_days': 'השלמת כל 7 הימים השבוע',
        'achievements.consistent_week': 'שבוע עקבי',
        'achievements.completed_5_days': 'השלמת 5+ ימים השבוע',
        'achievements.first_steps': 'צעדים ראשונים',
        'achievements.dedicated': 'מסור',
        'achievements.century': 'מאה',
        'achievements.year_round': 'לאורך השנה',

        // Crisis Support
        'crisis.title': 'תמיכה במשבר',
        'crisis.message': 'שמנו לב שאולי אתה עובר תקופה קשה. זכור, אתה לא לבד ויש עזרה זמינה.',
        'crisis.contact_therapist': 'צור קשר עם המטפל שלך',
        'crisis.hotline_suicide': 'ער"ן - עזרה ראשונה נפשית',
        'crisis.hotline_text': 'קו סיוע רגשי',
        'crisis.hotline_israel': 'ער"ן - עזרה ראשונה נפשית',
        'crisis.available_24_7': '24/7',
        'crisis.text_home': 'שלח הודעה',
        'crisis.phone_988': '988',
        'crisis.phone_eran': '1201',
        ...
        'reports.daily_checkin_title': 'דוחות צ\'ק-אין יומיים (7 ימים אחרונים)',
'reports.daily_checkin_desc': 'צור דוח מקיף של הצ\'ק-אינים שלך עבור 7 הימים האחרונים.',
    ...
    ru: {
        ...
        // Achievements
        'achievements.getting_started': 'Начало пути',
        'achievements.3_day_streak': '3-дневная серия',
        'achievements.week_warrior': 'Воин недели',
        'achievements.7_day_streak': '7-дневная серия',
        'achievements.fortnight_focus': 'Двухнедельный фокус',
        'achievements.14_day_streak': '14-дневная серия',
        'achievements.monthly_master': 'Мастер месяца',
        'achievements.30_day_streak': '30-дневная серия',
        'achievements.quarter_champion': 'Чемпион квартала',
        'achievements.90_day_streak': '90-дневная серия',
        'achievements.perfect_week': 'Идеальная неделя',
        'achievements.completed_7_days': 'Выполнены все 7 дней на этой неделе',
        'achievements.consistent_week': 'Последовательная неделя',
        'achievements.completed_5_days': 'Выполнено 5+ дней на этой неделе',
        'achievements.first_steps': 'Первые шаги',
        'achievements.dedicated': 'Преданный делу',
        'achievements.century': 'Столетие',
        'achievements.year_round': 'Круглый год',

        // Crisis Support
        'crisis.title': 'Кризисная поддержка',
        'crisis.message': 'Мы заметили, что вы, возможно, переживаете трудный период. Помните, вы не одиноки, и помощь доступна.',
        'crisis.contact_therapist': 'Свяжитесь с вашим терапевтом',
        'crisis.hotline_suicide': 'Линия предотвращения самоубийств',
        'crisis.hotline_text': 'Кризисная текстовая линия',
        'crisis.hotline_israel': 'ЭРАН - Эмоциональная первая помощь',
        'crisis.available_24_7': '24/7',
        'crisis.text_home': 'Отправьте сообщение',
        'crisis.phone_988': '988',
        'crisis.phone_eran': '1201',

    // Russian translations for therapist dashboard
'therapist.dashboard_title': 'Панель управления терапевта',
'therapist.dashboard_overview': 'Обзор панели управления',
'therapist.checkins_week': 'Отметки за неделю',
...
'reports.daily_checkin_title': 'Ежедневные отчеты об отметках (последние 7 дней)',
'reports.daily_checkin_desc': 'Создайте подробный отчет о ваших отметках за последние 7 дней.',
...
'therapist.email_required': 'Электронная почта*',
'therapist.temp_password': 'Временный пароль (необязательно)',
'therapist.auto_generate_note': 'Оставьте пустым для автоматической генерации',
'therapist.tracking_categories': 'Категории отслеживания',
'therapist.select_categories': 'Выберите, какие категории клиент будет отслеживать:',
'therapist.all_categories_note': 'Примечание: все категории выбраны по умолчанию. Снимите флажок с любой категории, которую вы не хотите отслеживать.',
...
'therapist.add_another_goal': '+ Добавить еще одну цель',
'therapist.create_client_btn': 'Создать учетную запись клиента',
'therapist.client_reports': 'Отчеты клиентов',
'therapist.generate_weekly_report': 'Создать еженедельный отчет',
...
'therapist.client_details': 'Данные клиента',
'therapist.no_clients': 'Клиенты не найдены. Добавьте своего первого клиента, чтобы начать.',
'therapist.license': 'Лицензия',
'therapist.activity_coming_soon': 'Функция недавней активности скоро появится',
'therapist.check_clients_tab': 'Проверьте вкладку клиентов, чтобы увидеть индивидуальный прогресс',
'therapist.max_goals': 'Можно добавить максимум 5 целей для начала',
...
'therapist.mark_as_mission': 'Отметить как задание',
'therapist.this_week_progress': 'Прогресс за эту неделю',
...
'therapist.preparing_email': 'Подготовка отчета email...',
'therapist.email_prepared': 'Отчет email подготовлен! Смотрите предварительный просмотр ниже.',
'therapist.error_loading': 'Ошибка загрузки панели управления:',
...
'therapist.error_loading_details': 'Ошибка загрузки данных клиента:',
'therapist.error_generating': 'Ошибка создания отчета:',
'therapist.error_preparing': 'Ошибка подготовки отчета email:',
'therapist.to': 'Кому',
'therapist.subject': 'Тема',
'therapist.email_preview': 'Предварительный просмотр отчета email',
'therapist.copy_email_note': 'Скопируйте это содержимое для отправки через ваш email',
'therapist.started': 'Начато',
'therapist.client_info': 'Информация о клиенте',
'therapist.week_progress': 'Прогресс за неделю',
'therapist.active_goals': 'Активные цели',
'therapist.no_active_goals': 'Нет активных целей на эту неделю',
'therapist.add_note_mission': 'Добавить заметку или задание',
'therapist.enter_note_placeholder': 'Введите вашу заметку или задание...',
'therapist.recent_notes': 'Недавние заметки и задания',
'therapist.mission': 'Задание',
'therapist.no_notes': 'Пока нет заметок',
'therapist.generate_pdf': 'Создать отчет PDF',
'client.generate_pdf': 'Создать отчет PDF',
...
'reports.daily_checkin_desc': 'Создайте подробный отчет о ваших отметках за последние 7 дней.',
    ...
    // Achievements
    'achievements.getting_started': 'البداية',
    'achievements.3_day_streak': 'سلسلة 3 أيام',
    'achievements.week_warrior': 'محارب الأسبوع',
    'achievements.7_day_streak': 'سلسلة 7 أيام',
    'achievements.fortnight_focus': 'تركيز الأسبوعين',
    'achievements.14_day_streak': 'سلسلة 14 يوم',
    'achievements.monthly_master': 'بطل الشهر',
    'achievements.30_day_streak': 'سلسلة 30 يوم',
    'achievements.quarter_champion': 'بطل الربع السنوي',
    'achievements.90_day_streak': 'سلسلة 90 يوم',
    'achievements.perfect_week': 'أسبوع مثالي',
    'achievements.completed_7_days': 'أكملت جميع الأيام السبعة هذا الأسبوع',
    'achievements.consistent_week': 'أسبوع متسق',
    'achievements.completed_5_days': 'أكملت 5 أيام أو أكثر هذا الأسبوع',
    'achievements.first_steps': 'الخطوات الأولى',
    'achievements.dedicated': 'مكرس',
    'achievements.century': 'قرن',
    'achievements.year_round': 'على مدار السنة',

    // Crisis Support
    'crisis.title': 'دعم الأزمات',
    'crisis.message': 'لاحظنا أنك قد تمر بوقت صعب. تذكر، أنت لست وحدك والمساعدة متاحة.',
    'crisis.contact_therapist': 'تواصل مع معالجك',
    'crisis.hotline_suicide': 'خط منع الانتحار',
    'crisis.hotline_text': 'خط الأزمات النصي',
    'crisis.hotline_israel': 'عيران - الإسعافات النفسية الأولية',
    'crisis.available_24_7': '24/7',
    'crisis.text_home': 'أرسل رسالة',
    'crisis.phone_988': '988',
    'crisis.phone_eran': '1201',
...
'reports.daily_checkin_title': 'تقارير تسجيل الحضور اليومية (آخر 7 أيام)',
'reports.daily_checkin_desc': 'أنشئ تقريراً شاملاً لتسجيلات حضورك عن آخر 7 أيام.',
