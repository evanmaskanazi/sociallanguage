...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port, debug=not os.environ.get('PRODUCTION')).rollback()
    return jsonify({'error': str(e)}), 500
...
def change_client_password():
    ...
    def export_client_data(client_id):
        ...
        try:
            ...
            responses = CategoryResponse.query.filter_by(client_id=client_id).order_by(
                CategoryResponse.response_date).all()
